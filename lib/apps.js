export const APPS = [
  ...
  {
    id: 'balcao-corporativo',
    name: 'Balcão Corporativo',
    shortDescription:
      'Marketplace interno estilo OLX para compra e venda entre colegas de trabalho.',
    status: 'available',
    statusLabel: 'Disponível',
    url: 'https://balcao.leandrosouza.info',
    icon: '🛒',
    featured: false,
  },
  {
...
export const UPCOMING_APPS = APPS.filter(
  (app) => !app.featured && app.status !== 'available'
)
